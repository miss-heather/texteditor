    ...
    var n = {
                ...
                function o() {
                    ...
                    function E(n) {
                        ...
                        1 in n && (r.catchLoc = n[1]),
                            2 in n &&
                                ((r.finallyLoc = n[2]), (r.afterLoc = n[3])),
            ...
            216: (n) => {
                ...
                n.exports = function (n) {
                    ...
                    return (
                        n.setAttributes(r, n.attributes),
                        n.insert(r, n.options),
                        r
                    );
                };
            },
    ...
    (t.n = (n) => {
        ...
        (() => {
            ...
            var f = (function (r) {
                    ...
                    return (
                        ...
                        (e.cn = function () {
                            var n = e.fn,
                                r = n.installing;
                            e.tn > 0 ||
                            !a(r.scriptURL, e.sn.toString()) ||
                            performance.now() > e.un + 6e4
                                ? ((e.vn = r),
                                  n.removeEventListener("updatefound", e.cn))
                                : ((e.hn = r), e.an.add(r), e.rn.resolve(r)),
                                ++e.tn,
                                r.addEventListener("statechange", e.ln);
                        }),
                        (e.ln = function (n) {
                            var r = e.fn,
                                t = n.target,
                                o = t.state,
                                a = t === e.vn,
                                c = { sw: t, isExternal: a, originalEvent: n };
                            !a && e.mn && (c.isUpdate = !0),
                                e.dispatchEvent(new i(o, c)),
                                "installed" === o
                ...
                (e = r),
                    ((t = s).prototype = Object.create(e.prototype)),
                ...
                return (
                    ...
                    (d.pn = function () {
                        ...
                        return n && a(n.scriptURL, this.sn.toString())
                            ? n
                            : void 0;
                    }),
                    (d.bn = function () {
                ...
                (function () {
                    ...
                    var r = n.prototype;
                    return (
                        (r.addEventListener = function (n, r) {
                            this.Sn(n).add(r);
                        }),
                        ...
                        (r.Sn = function (n) {
                            return (
                                this.Pn.has(n) || this.Pn.set(n, new Set()),
                                this.Pn.get(n)
                            );
                        }),
                        n
                ...
                get(n, r, t) {
                    if (n instanceof IDBTransaction) {
                        ...
                        if ("objectStoreNames" === r)
                            return n.objectStoreNames || k.get(n);
                        if ("store" === r)
            ...
            function j(n) {
                return "function" == typeof n
                    ? (r = n) !== IDBDatabase.prototype.transaction ||
            ...
            function M(
                n,
                r,
                { blocked: t, upgrade: e, blocking: o, terminated: a } = {}
            ) {
            ...
            function B(n, r) {
                ...
                const t = r.replace(/FromIndex$/, ""),
                    ...
                    o = O.includes(t);
                if (
                    !(t in (e ? IDBIndex : IDBObjectStore).prototype) ||
                    (!o && !T.includes(t))
                )
                    return;
                const a = async function (n, ...r) {
                    ...
                    return (
                        e && (i = i.index(r.shift())),
                        (await Promise.all([i[t](...r), o && a.done]))[0]
                    );
                };
                return D.set(r, a), a;
            }
            ...
            (rn.innerHTML = ""),
                void 0 === new U() &&
                    ((nn = document.createElement("div")).classList.add(
                        "spinner"
                    ),
                    (nn.innerHTML =
