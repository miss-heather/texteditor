(() => {
    var e = {
            ...
            721: (e, t, s) => {
                ...
                class x {
                    ...
                    async expireEntries(e, t) {
                        ...
                        const i = [];
                        for (const e of n)
                            await s.delete(b, e.id), i.push(e.url);
                        return i;
                    }
                    _getId(e) {
                        ...
                        return (
                            this._db ||
                                (this._db = await (function (
                                    ...
                                    upgrade: this._upgradeDbAndDeleteOldDbs.bind(
                                        this
                                    ),
                                })),
                            this._db
                ...
                class C {
                    ...
                    async isURLExpired(e) {
                        if (this._maxAgeSeconds) {
                            const t = await this._timestampModel.getTimestamp(
                                    e
                                ),
            ...
            202: (e, t, s) => {
                ...
                class o {
                    ...
                    _isResponseDateFresh(e) {
                        ...
                        return (
                            null === t ||
                            t >= Date.now() - 1e3 * this._maxAgeSeconds
                        );
                    }
            ...
            86: (e, t, s) => {
                ...
                function i(e) {
                    if (!e)
                        throw new n.V("add-to-cache-list-unexpected-type", {
                            entry: e,
                        });
                    if ("string" == typeof e) {
                        const t = new URL(e, location.href);
                ...
                class o {
                    constructor({ precacheController: e }) {
                        (this.cacheKeyWillBeUsed = async ({
                            ...
                            return s
                                ? new Request(s, { headers: e.headers })
                                : e;
                        }),
                    ...
                    _useDefaultCacheabilityPluginIfNeeded() {
                        ...
                        for (const [s, a] of this.plugins.entries())
                            a !== u.copyRedirectedCacheableResponsesPlugin &&
                                (a === u.defaultPrecacheCacheabilityPlugin &&
                                    (e = s),
                                a.cacheWillUpdate && t++);
                        0 === t
                            ? this.plugins.push(
                        ...
                        for (const s of e) {
                            ...
                            if (
                                ...
                                throw new n.V(
                                    ...
                                    {
                                        firstEntry: this._urlsToCacheKeys.get(
                                            a
                                        ),
                                        secondEntry: e,
                                    }
                ...
                class i extends r._ {
                    ...
                    async _handle(e, t) {
                        ...
                        const c = await t.waitUntil(
                            (async () =>
                                (await t.waitUntil(Promise.race(n))) ||
                                (await i))()
                        );
                    ...
                    async _getResponse(e, t, s) {
                        ...
                        try {
                            ...
                            if (n instanceof Error)
                                for (const r of e.iterateCallbacks(
                                    "handlerDidError"
                                ))
                                    if (
                                        ((a = await r({
            ...
            679: (e, t, s) => {
                ...
                function l(e = {}) {
                    ...
                    (0, a.X)(s, u),
                        e.warmCache && h({ urls: e.warmCache, strategy: u });
                }
                function u(e = {}) {
                    ...
                    (0, a.X)(s, c),
                        e.warmCache && h({ urls: e.warmCache, strategy: c });
                }
                s(144);
                var d = s(495);
                function f(e = {}) {
    ...
    (s.n = (e) => {
        ...
        (() => {
            ...
            (0, s(796).precacheAndRoute)([
                ...
                {
                    revision: "85be47af20ce0ea0232ca5ef290483fe",
                    url: "main.bundle.js",
                },
                {
                    revision: "4e0e34f265fae8f33b01b27ae29d9d6f",
            ...
            e({ urls: ["/index.html", "/"], strategy: o }),
                ...
                r(function (e) {
                    var t = e.request;
                    return ["style", "script", "worker"].includes(
                        t.destination
                    );
                }, new n({
